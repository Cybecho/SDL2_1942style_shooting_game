...
void InitGame() {
	...
	g_bg_source_rect.x = 150;
	g_bg_source_rect.y = 150;
	g_bg_source_rect.w = 720;
	g_bg_source_rect.h = 1280;

	g_bg_destination_rect.x = 0;
	g_bg_destination_rect.y = 0;
	g_bg_destination_rect.w = 720;
	g_bg_destination_rect.h = 1280;
	...
	// 그려질 위치
	g_player_destination_rect.x = 200;
	g_player_destination_rect.y = 800;
...
void Update() {
	...
	if (g_player_destination_rect.x > 720 - g_player_destination_rect.w) {
		g_player_destination_rect.x = 720 - g_player_destination_rect.w;
	}
	if (g_player_destination_rect.y < 0) {
		g_player_destination_rect.y = 0;
	}
	if (g_player_destination_rect.y > 1280 - g_player_destination_rect.h) {
		g_player_destination_rect.y = 1280 - g_player_destination_rect.h;
	}
